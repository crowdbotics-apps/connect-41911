"""
Django settings for connect_41911 project.
...
ROOT_URLCONF = 'connect_41911.urls'
...
WSGI_APPLICATION = 'connect_41911.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "connect_41911 API",
    "DESCRIPTION": "API documentation for connect_41911 App",
    "VERSION": "v1",
}
